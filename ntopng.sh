...
echo -e "Installation de ntopng-2.4-stable:\n"


wget http://downloads.sourceforge.net/project/ntop/ntopng/ntopng-2.4-stable.tar.gz
tar -zxvf ntopng-2.4-stable.tar.gz
mv ntopng-2.4-stable /opt/ntopng
cd /opt/ntopng
